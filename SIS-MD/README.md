...
```
SIS-MD/
├── SIS.md                    # Main skill definition (entry point)
├── modules/
│   ├── metadata.md           # Metadata Intelligence module
│   ├── secrets.md            # Secret & Sensitive Data Detection module
│   └── fingerprinting.md     # Technology & Infrastructure Fingerprinting module
├── examples/
│   └── sample-report.md      # Worked example output
├── CHANGELOG.md
├── LICENSE
└── README.md
```
...
Issues and PRs welcome — especially additional detection patterns, module ideas for v2 (dependency/CVE cross-referencing, structured JSON output mode), or compatibility notes for other AI platforms.
